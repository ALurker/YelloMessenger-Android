This Android Application is a simple text message listener and sender. It will forward a text message based upon the current network name, and send texts it receives on port 1337.
